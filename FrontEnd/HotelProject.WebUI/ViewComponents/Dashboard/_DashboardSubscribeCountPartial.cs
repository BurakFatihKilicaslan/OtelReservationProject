    ...
    public class _DashboardSubscribeCountPartial : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://instagram-profile1.p.rapidapi.com/getprofileinfo/burak.fatihhh"),
                Headers =
    {
        { "X-RapidAPI-Key", "64bb21a051msha60401856763c92p1060bajsn4e4796da9f51" },
        { "X-RapidAPI-Host", "instagram-profile1.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://twitter32.p.rapidapi.com/getProfile?username=burakfatihhh"),
                Headers =
    {
        { "X-RapidAPI-Key", "64bb21a051msha60401856763c92p1060bajsn4e4796da9f51" },
        { "X-RapidAPI-Host", "twitter32.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://fresh-linkedin-profile-data.p.rapidapi.com/get-linkedin-profile?linkedin_url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fburakfatihkilicaslan%2F"),
                Headers =
    {
        { "X-RapidAPI-Key", "64bb21a051msha60401856763c92p1060bajsn4e4796da9f51" },
